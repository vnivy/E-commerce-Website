  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/bannerr.jpg" alt="Los Angeles" style="width:100%;height: 60vh;">
        
      </div>

      <div class="item">
        <img src="img/1banner.jpg" style="width:100%;height: 60vh;">
        
      </div>
    
      <div class="item">
        <img src="img/2banner.jpg" alt="New York" style="width:100%;height: 60vh;">
        
      </div>
      <div class="item">
        <img src="img/5banner.jpg" alt="New York" style="width:100%;height: 60vh;">
        
      </div>
      <div class="item">
        <img src="img/4banner.jpg" alt="New York" style="width:100%;height: 60vh;">
...
<div class="container-fluid mainn" style="padding-bott: 40px;border-radius:10px;">
	<div class="row">
	<h4 style="margin-left:170px;">UP TO 60% OFF | CAMERAS AND ACCESSORIES</h4>
    ...
    <div class="carousel-inner ">
      <div class="item active">
        <img src="img\new1.jpg" alt="new1" style="width:100%;">
      </div>

      <div class="item">
        <img src="img\new2.jpg" alt="new2" style="width:100%;">
      </div>
    
      <div class="item">
        <img src="img\new3.jpg" alt="new3" style="width:100%;">
      </div>
    </div>
...
<div class="row">
          <img src="img/offer.png" style="width:100%; padding-top:30px">
</div>
</div>
...
<div class="container-fluid">
<div class="row">
          <img src="img/image1.png" style="width:100%;padding-top:30px">
...
<div class="container-fluid">
<div class="row">
          <img src="img/top1.png" style="width:100%;padding-top:30px">
