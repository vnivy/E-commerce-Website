...
<body style="background: #fff;">
                        ...
                        <div class="header-logo">
                            <a href="#" class="logo">
                                <font style="font-style:normal; font-size: 33px;color: aliceblue;font-family: serif">
                                    <img src="./img/capture2.png" style="width: 162px;">
                                </font>
                        ...
                        <div class="header-search">
                            <form>
                                <select class="input-select">
                                    ...
                                    <option value="0">Alexa Skills</option>
                                    <option value="0">All Categories</option>
                                    <option value="0">Amazon Devices</option>
                                    <option value="0">More Stores</option>
                                    <option value="0">Amazon Fashion</option>
                                    <option value="0">Amazon Pantry</option>
                                    <option value="0">Appliances</option>
                                    <option value="0">Apps & Games</option>
                                    <option value="0">Baby</option>
                                    <option value="0">Beauty</option>
                                    <option value="0">Computer & Electronics</option>
                                    <option value="0">Funiture</option>
                                    <option value="0">Gift Cards</option>
                                    <option value="0">Home & Kitchen</option>
                                    <option value="0">Jewelry</option>
                                    <option value="0">Kindle Store</option>
                                </select>
                                <input class="input" id="search" type="text" placeholder="Search here">
                                <button type="submit" id="search_btn" class="search-btn" style="background: orange;position: absolute;
    color: #fff;">Search</button>
                        ...
                        <div class="header-ctn">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                    ...
                                    <span>Your Cart</span>
                                    <div class="badge qty" style="color:white">0</div>
                                </a>
                            ...
                            if(isset($_SESSION["uid"])){
                               ...
                               <div class="dropdownn">
                                  ...
                                  <div class="dropdownn-content">
                                    <a href="" data-toggle="modal" data-target="#profile"><i class="fa fa-user-circle" style="font-size: 18px;" aria-hidden="true" ></i>My Profile</a>
                    ...
                    <a href="/login.php"> <i class="fa fa-lock" style="color:orange" aria-hidden="true"></i></a>
                    <style type="text/css">
                        .header-links li i {
    color: orange;
    margin-right: 15px;
