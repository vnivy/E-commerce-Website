				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">Rs'.$row['product_price'].'<del class="product-old-price">Rs '.$row['product_discount'].'</del></h3>
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab2" class="tab-pane fade in">
									<div class="row">
										<div class="col-md-12">
											<p>HP Pavilion is a line of consumer-oriented laptop and desktop computers produced by HP Inc.. It was introduced in 1995 by erstwhile Hewlett-Packard. The name is applied to both desktops and laptops for the Home and Home Office product range. The Pavilion mainly competes against computers such as Acers Aspire, Dells Inspiron and XPS, Lenovo IdeaPad, Samsung Sens and Toshiba Satellite.</p>
										</div>
									</div>
								</div>
								<!-- /tab2  -->
