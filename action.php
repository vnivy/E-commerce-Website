                        ...
                        <div class='col-md-4 col-xs-6'>
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										<p class='product-category'>$cat_name</p>
										<h3 class='product-name header-cart-item-name'><a href='product.php?p=$pro_id'>$pro_title</a></h3>
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>Rs $pro_dis</del></h4>
		...
		if (mysqli_num_rows($query) > 0) {
			...
			<form method="post" action="login_form.php">
	               ...
	               <table id="cart" class="table table-hover table-condensed" id="">
    				<thead>
						<tr>
							<th style="width:50%;    padding-left: 113px;">Product</th>
						...
						<tr>
							<td data-th="Product" >
								<div class="row">
									...
									<div class="col-sm-4 text-center"><img src="product_images/'.$product_image.'" style="height: 70px;width:75px; text-align:center;"/>
									<h4 class="nomargin product-name header-cart-item-name"><a href="product.php?p='.$product_id.'">'.$product_title.'</a></h4>
									</div>
									<div class="col-sm-6">
										<div style="max-width=50px; text-align:center;">
										<p>HP Pavilion is a line of consumer-oriented laptop and desktop computers produced by HP Inc.. It was introduced in 1995 by erstwhile Hewlett-Packard. The name is applied to both desktops and laptops for the Home and Home Office product range. The Pavilion mainly competes against computers such as Acers Aspire, Dells Inspiron and XPS, Lenovos IdeaPad, Samsungs Sens and Toshibas Satellite.</p>
										</div>
									</div>
