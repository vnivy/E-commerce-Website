					...
					<div class="col-md-12">
						...
						<div class="newsletter">
							...
							<form id="offer_form" onsubmit="return false">
								...
								<button class="newsletter-btn" value="Sign Up" name="signup_button" type="submit" style="background:orange;
    color: #fff;background-color:orange;"><i class="fa fa-envelope"></i> Subscribe</button>
							</form>
